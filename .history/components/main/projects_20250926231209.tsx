...
<h2 className="text-4xl font-medium text-white mb-8">
 ...
 {/* Main Description */}
  ...
  <ul className="list-disc list-inside text-gray-200 mt-2 text-left max-w-3xl px-6">
    ...
    <li><strong>Controller/Communication</strong> — team builds an RF or wired controller to control the robot. A human will control the robot&#39s motion and decisions.</li>
